...
import restaurant.petproject.service.ShoppingCartService;
...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public ShoppingCart addShoppingCartFirstTime(Long id, String sessionToken, int quantity) {
        ...
        cartItem.setDish(dishService.getDishById(id));
    ...
    public ShoppingCart addToExistingShoppingCart(Long id, String sessionToken, int quantity) {
        ...
        Boolean dishDoesExistInTheCart = false;
        if(shoppingCart != null) {
            Set<CartItem> items = shoppingCart.getItems();
            for(CartItem item : items){
                if(item.getDish().equals(d)){
                    dishDoesExistInTheCart = true;
        ...
        if(!dishDoesExistInTheCart && (shoppingCart != null)){
